...
- If continuing plugin migration, prefer extending tests or adding new analysis plugins rather than revisiting the already-migrated wave/DC/AC heatmap paths.
